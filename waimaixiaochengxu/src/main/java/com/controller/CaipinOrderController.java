...
//                            caipinOrderEntity.setCaipinOrderText(data.get(0));                    //订单备注 要改的
...
//                            caipinOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        String caipinOrderText = String.valueOf(String.valueOf(params.get("caipinOrderText")));//订单备注
        ...
        for (Map<String, Object> map : caipins) {
           //取值
            ...
            caipinOrderEntity.setCaipinOrderText(caipinOrderText);//订单备注 ？？？？？？
