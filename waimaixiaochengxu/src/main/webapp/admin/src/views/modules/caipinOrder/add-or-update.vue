        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="订单备注" prop="caipinOrderText">
                        <el-input type="textarea"  :readonly="ro.caipinOrderText" v-model="ruleForm.caipinOrderText" placeholder="订单备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.caipinOrderText" label="订单备注" prop="caipinOrderText">
